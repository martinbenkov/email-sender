...
@Component
public class EmailSendingRouter implements Runnable, InitializingBean
{
	private final static Logger logger = LoggerFactory.getLogger(EmailSendingRouter.class);
